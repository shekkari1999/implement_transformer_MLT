...
### this methods is for validations
...
def greedy_decode(model, source, source_mask, tokenizer_src, tokenizer_tgt, max_len, device):
    ...
    while True:
        ...
        # build mask for the next target(decoder input)
        ...
        #select the token with the max probability(can improvements be made here ? )
...
def train_model(config):
    ...
    for epoch in range(initial_epoch, config['num_epochs']):
        ...
        ### to resume training we need to save
